...
- [lib_meta.md](lib_meta.md) - `VERSION` (interpreter build version)
...
[lib_meta.md](lib_meta.md) for the format).
...
internal/lib/meta/metalib.go      `meta` library: VERSION constant
